...
## R packages
Um *R package* é um conjunto de funções que extendem a capacidade da base R. Na análise exploratória de dados, um pacote importante é o tidyverse(). Para o instalar, basta escrever a seguinte linha de código:

```
install.packages("tidyverse")
```

Após instalar um pacote, é necessário carregá-lo para poder utilizar todas as funcionalidades do pacote. Portanto, basta utilizar a função `library()` para instalar, inserindo o nome do pacote como argumento. Nesse caso, não utiliza-se aspas no argumento.