...
Para um conjunto de dados com numerações para cada uma das observações, para selecionar as 4 primeiras observações, basta realizar o comando `dados[1:4,]`, por exemplo.
