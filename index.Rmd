...
R é uma linguagem e ambiente para computação estatística e gráficos. Essa linguagem de programação fornece um grande variedade de técnicas estatísticas (R provides a wide variety of statistical (linear and nonlinear modelling, classical statistical tests, time-series analysis, classification, clustering, …) and graphical techniques, and is highly extensible. 
