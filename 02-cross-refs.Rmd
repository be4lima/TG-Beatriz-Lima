...
Existem pré-requisitos para a regressão linear: homocedasticidade, normalidade dos resíduos, independência dos resíduos e ausência de outliers influentes.
