...
Para descobrir qual modelo descreve melhor o comportamento dos dados, inicialmente, realiza-se uma análise gráfica, verificando estacionaridade, tendência, sazonalidade, etc. A partir disso, verifica-se a ordem de integração da série, ou seja, número de diferenças necessárias para tornar uma série estacionária. Para isso, realiza-se o teste de Dickey-Fuller em que:
